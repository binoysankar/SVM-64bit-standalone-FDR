...
public class LocationUtils {
	...
	public static String getPhone(Properties props) {
		return country2phone.get(props.getProperty("country.code").toUpperCase());
//	    return country2phone.get(new LocationUtils().getCountryCode().toUpperCase());
	}
	...
	public String getCountryCode() {
		...
		try {
			...
			File file = new File(LocationUtils.class.getClassLoader().getResource("GeoLiteCity.dat").getPath());

			LookupService lookup = new LookupService(file, LookupService.GEOIP_MEMORY_CACHE);
			Location locationServices = lookup.getLocation(ipAddress);

			countryCode = locationServices.countryCode;
			/*String countryName = locationServices.countryName;
			String region = locationServices.region;
			String city = locationServices.city;
			String postalCode = locationServices.postalCode;
			String latitude = String.valueOf(locationServices.latitude);
			String longitude = String.valueOf(locationServices.longitude);*/
